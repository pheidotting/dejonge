...
public class TodoistController {
    ...
    @RequestMapping(method = RequestMethod.POST, value = "/oauthToken")
    @ResponseBody
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/getPrefix")
    @ResponseBody
    public String getPrefix() {
        return todoistPrefix;
    }

    @RequestMapping(method = RequestMethod.GET, value = "/getClientIdEnClientSecret")
    @ResponseBody
