...
--changeset Patrick Heidotting:86
ALTER TABLE `BIJLAGE` ADD COLUMN `ENTITEITID` bigint(20);
UPDATE BIJLAGE SET ENTITEITID =  IFNULL(IFNULL(IFNULL(IFNULL(IFNULL(IFNULL(IFNULL(POLIS,SCHADE),HYPOTHEEK),AANGIFTE),RELATIE),BEDRIJF),JAARCIJFERS),RISICOANALYSE);
UPDATE BIJLAGE SET SOORTBIJLAGE = 'POLIS' WHERE `POLIS` IS NOT NULL;
UPDATE BIJLAGE SET SOORTBIJLAGE = 'SCHADE' WHERE `SCHADE` IS NOT NULL;
UPDATE BIJLAGE SET SOORTBIJLAGE = 'HYPOTHEEK' WHERE `HYPOTHEEK` IS NOT NULL;
UPDATE BIJLAGE SET SOORTBIJLAGE = 'AANGIFTE' WHERE `AANGIFTE` IS NOT NULL;
UPDATE BIJLAGE SET SOORTBIJLAGE = 'RELATIE' WHERE `RELATIE` IS NOT NULL;
UPDATE BIJLAGE SET SOORTBIJLAGE = 'BEDRIJF' WHERE `BEDRIJF` IS NOT NULL;
UPDATE BIJLAGE SET SOORTBIJLAGE = 'JAARCIJFERS' WHERE `JAARCIJFERS` IS NOT NULL;
UPDATE BIJLAGE SET SOORTBIJLAGE = 'RISICOANALYSE' WHERE `RISICOANALYSE` IS NOT NULL;
ALTER TABLE `BIJLAGE`
  DROP `POLIS`,
  DROP `SCHADE`,
  DROP `HYPOTHEEK`,
...
UPDATE OPMERKING SET ENTITEITID =  IFNULL(IFNULL(IFNULL(IFNULL(IFNULL(IFNULL(IFNULL(POLIS,SCHADE),HYPOTHEEK),AANGIFTE),RELATIE),BEDRIJF),JAARCIJFERS),RISICOANALYSE);
...
--UPDATE TELEFOONNUMMER SET ENTITEITID =  IFNULL(IFNULL(RELATIE,BEDRIJF),CONTACTPERSOON);
--UPDATE TELEFOONNUMMER SET SOORTENTITEIT = 'RELATIE' WHERE `RELATIE` IS NOT NULL;
--UPDATE TELEFOONNUMMER SET SOORTENTITEIT = 'BEDRIJF' WHERE `BEDRIJF` IS NOT NULL;
--UPDATE TELEFOONNUMMER SET SOORTENTITEIT = 'KANTOOR' WHERE `CONTACTPERSOON` IS NOT NULL;
