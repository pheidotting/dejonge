...
UPDATE TELEFOONNUMMER SET ENTITEITID =  IFNULL(IFNULL(RELATIE,CONTACTPERSOON),BEDRIJF);
UPDATE TELEFOONNUMMER SET SOORTENTITEIT = 'RELATIE' WHERE `RELATIE` IS NOT NULL;
UPDATE TELEFOONNUMMER SET SOORTENTITEIT = 'BEDRIJF' WHERE `RELATIE` IS NOT NULL;
